...
cp $SLURM_TMPDIR/fmriprep_study-harrypotter_sub-03/resource_monitor.json /scratch/bpinsard/fmriprep_study-harrypotter_sub-03_resource_monitor.json 
if [ $fmriprep_exitcode -ne 0 ] ; then cp -R $SLURM_TMPDIR/fmriprep_study-harrypotter_sub-03 /scratch/bpinsard/fmriprep_study-harrypotter_sub-03 ; fi 
